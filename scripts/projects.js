...
const projects = [
  ...
  //   name: "NewsExplorer",
  //   description:
  //     "This application allows users to login and explore the day's news using the News API. Users can search for, read, and save articles according to their interests. This project is the capstone project of my education at TripleTen.",
  ...
  //   name: "Apiary",
  //   description:
  //     "A single page application built for TripleTen's Apiary program, which lets students build pages for startups in order to gain experience. Clients may update the page content via Contentful. Queries are sent using GraphQL and managed with Apollo Client. ",
